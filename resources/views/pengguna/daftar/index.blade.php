    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3 class="text-success">Daftar Pengguna</h3>
            </div>
        ...
        <div class="col-12">
            <div class="card border">
                <div class="card-header">
                    <a href="/pengguna/daftar/create" class="btn btn-orange">
                        <b class="d-flex align-items-center"><i class="bi bi-plus-circle"></i>Tambah Pengguna</b>
                    </a>
                </div>
                <div class="card-body">
                    @if (count($pengguna) > 0 )
                            ...
                            @foreach ($pengguna as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/pengguna/daftar/{{ $row->user_id }}/edit" class="badge bg-warning"><i class="bi bi-pencil-square"></i></a>

                                        <a href="" class="badge bg-success" data-bs-toggle="modal" data-bs-target="#ubah-status-{{ $row->user_id }}"><i class="bi bi-person-check-fill"></i></a>

                                        <!-- Modal -->
                                        <div class="modal fade" id="ubah-status-{{ $row->user_id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
